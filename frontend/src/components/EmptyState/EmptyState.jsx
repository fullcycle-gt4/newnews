export default function EmptyState({ searchQuery, isSavedTabActive, category, onClearSearch, onResetCategory }) {
  ...
  return (
    <div className="text-center py-5 px-3">
      ...
      {!hasActiveSearch && !isSavedTabActive && (
        <button className="btn btn-outline-secondary btn-sm rounded-pill px-3" onClick={onResetCategory}>
